function highscoreData() {
	var lastGameDate = "10/14/2023";
	
	var scores = [
			{name:"ALEX",scores:[101,121,36,101,162,91,90,68,90,106,77,100,121,95,123,121,75,50,37,119]},
			{name:"ROMEO",scores:[103,148,74,111,123,124,115,122,107,83,173,152,190,136,145,148,47,57,87]},
			{name:"SHEKI",scores:[113,92,57,120,147,52,124,124,111,122,100,193,122,78,114,124,85,75,49]},
			{name:"HAZEL",scores:[68,102,76,76,99,102,67,86,101,85,100,136,105,105,126,87,86,26,136,100]},
			{name:"CLINT",scores:[103,120,125,112,113,90,115,104]},
			{name:"---",scores:[71,86,80,125,99]}, // rk
			{name:"YVES",scores:[65,92]},
			{name:"NICOLE",scores:[154,47]},
			{name:"SHAIRA",scores:[86,66,62,62,77]},
			{name:"---",scores:[43,115,32,89,87,85,104,97,111,112,101,165,73,113]}, // poy
			{name:"---",scores:[76,100,103]}, // patmae
		        {name:"DARWIN",scores:[43,67]},
		        {name:"ECHO",scores:[33,122]}
		     ]
